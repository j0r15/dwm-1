...
const char *spcmd1[] = {TERMINAL, "-n", "spterm", "-f", "Terminus:size=10", "-g", "120x34", NULL };
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "Terminus:size=10", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
static const Rule rules[] = {
	...
	*/
	...
	{ "Xfce4-notes",     NULL,       NULL,       	    1 << 6,       1,           0,         0,        -1 },
};
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_w,		spawn,		SHCMD("firefox -p private") },
	...
	{ MODKEY|ControlMask|ShiftMask,		XK_o,		incnmaster,     {.i = 0 } },
	...
	{ MODKEY,			XK_F1,		spawn,		SHCMD("sudo dmenumount") },
	{ MODKEY,			XK_F2,		spawn,		SHCMD("sudo dmenuumount") },
